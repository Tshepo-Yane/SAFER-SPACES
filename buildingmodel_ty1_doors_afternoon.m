...
function dy=buildingmodel_ty1_doors_afternoon(t,y,N)
...
ACH_3=10; % air changes per hour for research space
ACH_4=4; % air changes per hour for office space
ACH_5=10; % air changes per hour for research space
ACH_6=4; % air changes per hour for office space
ACH_7=4; % air changes per hour for office space
ACH_8=10; % air changes per hour for research space
