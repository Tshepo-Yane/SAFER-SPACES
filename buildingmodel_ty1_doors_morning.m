%% Morning condtions 
function dy=buildingmodel_ty1_doors_morning(t,y,N)
...
ACH_1=3; % air changes per hour for entry/hallway
ACH_2=3; % air changes per hour for office space
ACH_3=12; % air changes per hour for research space
ACH_4=3; % air changes per hour for office space
ACH_5=12; % air changes per hour for research space
ACH_6=3; % air changes per hour for office space
ACH_7=3; % air changes per hour for office space
ACH_8=12; % air changes per hour for research space
ACH_9=3; % air changes per hour for office space
...
r_1=0.6; %fraction of recycled air in entry/hallway
r_2=0.65; %fraction of recycled air in office space
r_3=0.0; %fraction of recycled air in research space
r_4=0.65; %fraction of recycled air in office space
r_5=0.0; %fraction of recycled air in research space
r_6=0.65; %fraction of recycled air in office space
r_7=0.65; %fraction of recycled air in office space
r_8=0.0; %fraction of recycled air in research space
r_9=0.65; %fraction of recycled air in office space
...
part_per_breadth= 1e5; % particles per breadth 
...
% H=1;
% diff=1;
% dy(1)=H*(Q_f_1*C_air/V1 - Q_e_1*y(1)/V1 + Q_r_1*filter7*y(1)/V1) - diff*(1*Pdoor*(y(1)-y(2))*Adoor/V1 - 1*Pdoor*(y(1)-y(3))*Adoor/V1 - 1*Pdoor*(y(1)-y(4))*Adoor/V1 - 1*Pdoor*(y(1)-y(5))*Adoor/V1 - 1*Pdoor*(y(1)-y(6))*Adoor/V1 - 2*Pdoor*(y(1)-y(7))*Adoor/V1 - 1*Pdoor*(y(1)-y(8))*Adoor/V1 - 2*Pdoor*(y(1)-y(9))*Adoor/V1)+(D1/(2*floor_height))*(p_inf*exhale - y(1)*p_non_inf*inhale-y(1)*p_inf*inhale);
% 
% dy(2)=H*(Q_f_2*C_air/V2 - Q_e_2*y(2)/V2 + Q_r_2*filter7*y(2)/V2) + diff*(1*Pdoor*(y(1)-y(2))*Adoor/V2)+(D2 /floor_height)*(p_inf*exhale - y(2)*p_non_inf*inhale-y(2)*p_inf*inhale);
% 
% dy(3)=H*(Q_f_3*C_air/V3 - Q_e_3*y(3)/V3 + Q_r_3*filter14*y(3)/V3) + diff*(1*Pdoor*(y(1)-y(3))*Adoor/V3) - 1*Pdoor*(y(3)-y(4))*Adoor/V3 +(D3 /floor_height)*(p_inf*exhale - y(3)*p_non_inf*inhale-y(3)*p_inf*inhale);
% 
% dy(4)=H*(Q_f_4*C_air/V4 - Q_e_4*y(4)/V4 + Q_r_4*filter7*y(4)/V4) + diff*(1*Pdoor*(y(1)-y(4))*Adoor/V4)+(D4 /floor_height)*(p_inf*exhale - y(4)*p_non_inf*inhale-y(4)*p_inf*inhale);
% 
% dy(5)=H*(Q_f_5*C_air/V5 - Q_e_5*y(5)/V5 + Q_r_5*filter14*y(5)/V5) + diff*(1*Pdoor*(y(1)-y(5))*Adoor/V5)+(D5 /floor_height)*(p_inf*exhale - y(5)*p_non_inf*inhale-y(5)*p_inf*inhale);
% 
% dy(6)=H*(Q_f_6*C_air/V6 - Q_e_6*y(6)/V6 + Q_r_6*filter7*y(6)/V6) + diff*(1*Pdoor*(y(1)-y(6))*Adoor/V6)+(D6 /floor_height)*(p_inf*exhale - y(6)*p_non_inf*inhale-y(6)*p_inf*inhale);
% 
% dy(7)=H*(Q_f_7*C_air/V7 - Q_e_2*y(7)/V7 + Q_r_7*filter7*y(7)/V7) + diff*(2*Pdoor*(y(1)-y(7))*Adoor/V7)+(D7 /floor_height)*(p_inf*exhale - y(7)*p_non_inf*inhale-y(7)*p_inf*inhale);
% 
% dy(8)=H*(Q_f_8*C_air/V8 - Q_e_8*y(8)/V8 + Q_r_8*filter14*y(8)/V8) + diff*(1*Pdoor*(y(1)-y(8))*Adoor/V8)+(D8 /floor_height)*(p_inf*exhale - y(8)*p_non_inf*inhale-y(8)*p_inf*inhale);
% 
% dy(9)=H*(Q_f_9*C_air/V9 - Q_e_2*y(9)/V9 + Q_r_9*filter7*y(9)/V9) + diff*(2*Pdoor*(y(1)-y(9))*Adoor/V9)+(D9 /floor_height)*(p_inf*exhale - y(9)*p_non_inf*inhale-y(9)*p_inf*inhale);
% 
